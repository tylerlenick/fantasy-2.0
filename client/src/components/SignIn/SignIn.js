      ...
      <Paper className={classes.paper}>
        ...
        <form className={classes.form}>
          <FormControl margin="normal" required fullWidth>
            ...
            <Input value = {props.username} onChange = {props.handleChange} name='username' type='email' autoFocus />
          </FormControl>
          <FormControl margin="normal" required fullWidth>
            <InputLabel htmlFor="password">Password</InputLabel>
            <Input name='password' type='password' value = {props.password} onChange = {props.handleChange} autoComplete="current-password" />
          </FormControl>
          <FormControlLabel
